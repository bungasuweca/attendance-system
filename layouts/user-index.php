...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper">
        <?php require_once('./components/sidebar-user.php'); ?>
                        ...
                        <div class="container">
                            <div class="row d-flex align-items-center py-1">
                                <div class="col-12 col-lg-7">
                                    <h1 class="text-gray-800">Welcome!</h1>
                                    <p>Don't miss your attendance today!
                                    </p>
                                    <div class="row">
                                        <a href="attendance-log.php" class="btn btn-blue mx-3">Clock In</a>
                                        <a href="attendance-log.php" class="btn btn-outline-primary mx-1">Clock Out</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Business Days</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">260 days</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">To Do List
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <div class=" container " style="height:auto;">
                                            <div>
                                                <div class="row">
                                                    <div class=" col-8">
                                                        <input class=" py-3 form-control" placeholder="input your task"
                                                            type="text" id="inputText">
                                                    </div>
                                                    <div class="col-2">
                                                        <!-- <i onclick="addList()" class=" btn btn-dark rounded-pill fas fa-4x fa-plus-circle "></i> -->
                                                        <button onclick="addList()" class="btn btn-blue"> Add
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Task -->
                                        <script>let input = document.getElementById("inputText");
                                            ...
                                            addList = () => {
                                                ...
                                                // set 
                                                if (inputText) {
                                                    list.innerHTML += ` <li class=" list-group " id="list${listNum}">
                <div class="row">
                <div class="col-2">
                ...
                <div class="col-4">
                     ...
                     <button class=" btn btn-dark" onclick="editList(${listNum})">Edit</button>
                            ...
                            <div class="card shadow mt-4">
                                ...
                                <div class="card-body">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex voluptatum, harum
                                        repellendus eligendi voluptas iure id nobis repellat explicabo molestias quo,
                                        odit quia similique illum ullam pariatur in ut cupiditate.</p>
                                </div>
                            </div>
